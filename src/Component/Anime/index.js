                    ...
                    return(
                        <div className='col col-sm-4 col-md-3  my-1 example' key={anime.mal_id}>
                            <Link to={`./${anime.mal_id}`} style={{textDecoration: "none", color: "black"}}>
                                <div >
                                    <img src={anime.images.webp.image_url} className="rounded my-auto" style={{height: "400px"}}/>
                                </div>
                            </Link>
                            <div className='container-fluid'>
                                <button className=' m-2 btn btn-dark' onClick={()=> handleAddToCart(anime)}>WatchLater</button>
                            </div>
                        </div>
                    )
                })}
